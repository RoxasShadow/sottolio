...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$[]=', '$delete', '$delete_if', '$to_proc', '$[]', '$include?', '$alias_method']);
  return (function($base) {
    var self = $module($base, 'Sottolio');

    var def = self._proto, $scope = self._scope, $a;
    (function($base, $super) {
      function $Database(){};
      var self = $Database = $klass($base, $super, 'Database', $Database);

      var def = $Database._proto, $scope = $Database._scope, TMP_1;
      def.db = nil;
      self.$attr_accessor("db");

      def.$initialize = function() {
        var self = this;
        return self.db = $hash2([], {});
      };

      def.$add = function(key, value) {
        var self = this;
      ...
      def.$delete_if = TMP_1 = function(key) {
        var $a, $b, self = this, $iter = TMP_1._p, block = $iter || nil;
        TMP_1._p = null;
        return ($a = ($b = self.db).$delete_if, $a._p = block.$to_proc(), $a).call($b, key);
      };
      ...
      def['$has?'] = function(key) {
        var self = this;
        return self.db['$include?'](key);
      };

      self.$alias_method("exist?", "has?");

      self.$alias_method("exists?", "has?");

      return self.$alias_method("include?", "has?");
    })(self, null);
    ...
    (function($base, $super) {
      ...
      var def = $Block._proto, $scope = $Block._scope;
      def.block = nil;
      self.$attr_accessor("block");
      ...
      def['$free?'] = function() {
        var $a, self = this;
        return ($a = self.block, ($a === nil || $a === false));
      };
      ...
      return (def['$free!'] = function() {
        var self = this;
        return self.block = false;
      }, nil);
    })(self, null);

    $opal.defs((($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a), '$get', function(id) {
      var self = this;
      return document.getElementById(id);
    });

    $opal.defs((($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a), '$add_listener', function(event, element, callback) {
      var self = this;
...
//@ sourceMappingURL=/__opal_source_maps__/sottolio.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $range = $opal.range;
  $opal.add_stubs(['$[]', '$join', '$tap', '$each', '$<<', '$inspect', '$+', '$each_with_index', '$keys', '$values', '$has?', '$get', '$split', '$last']);
  (function($base, $super) {
    function $Array(){};
    var self = $Array = $klass($base, $super, 'Array', $Array);
    ...
    def.$to_js = function() {
      var $a, $b, TMP_1, self = this;
      return ($a = ($b = []).$tap, $a._p = (TMP_1 = function(s){var self = TMP_1._s || this, $a, $b, TMP_2;if (s == null) s = nil;
      return ($a = ($b = self).$each, $a._p = (TMP_2 = function(a){var self = TMP_2._s || this;if (a == null) a = nil;
        return s['$<<']("" + (a) + ", ")}, TMP_2._s = self, TMP_2), $a).call($b)}, TMP_1._s = self, TMP_1), $a).call($b).$join()['$[]']($range(0, -3, false));
    };
  ...
  (function($base, $super) {
    ...
    def.$to_js = function() {
      var $a, $b, TMP_3, self = this;
      return ($a = ($b = ["{ "]).$tap, $a._p = (TMP_3 = function(s){var self = TMP_3._s || this, $a, $b, TMP_4;if (s == null) s = nil;
      return ($a = ($b = self.$keys()).$each_with_index, $a._p = (TMP_4 = function(k, i){var self = TMP_4._s || this;if (k == null) k = nil;if (i == null) i = nil;
        return s['$<<']("" + (self.$keys()['$[]'](i)) + ": '" + (self.$values()['$[]'](i)) + "', ")}, TMP_4._s = self, TMP_4), $a).call($b)}, TMP_3._s = self, TMP_3), $a).call($b).$join()['$[]']($range(0, -3, false))['$+'](" }");
    };
  ...
  return (function($base, $super) {
    ...
    var def = $String._proto, $scope = $String._scope;
    def.$apply = function(database, pattern) {
      var $a, $b, TMP_5, self = this, r = nil;
      if (pattern == null) {
        pattern = /\#(.+)\#/
      }
      r = "";
      ($a = ($b = self.$split(pattern)).$each, $a._p = (TMP_5 = function(s){var self = TMP_5._s || this, $a;if (s == null) s = nil;
      return r = r['$+'](((function() {if (($a = database['$has?'](s)) !== false && $a !== nil) {
          return database.$get(s)
          } else {
          return s
        }; return nil; })()))}, TMP_5._s = self, TMP_5), $a).call($b);
      return r;
    };
...
//@ sourceMappingURL=/__opal_source_maps__/utils.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash = $opal.hash;
  $opal.add_stubs(['$include', '$instance_eval', '$to_proc', '$block', '$any?', '$each', '$<<', '$alias_method', '$==', '$to_sym', '$first', '$keys', '$count', '$select', '$inspect', '$length', '$instance_variable_set', '$instance_variable_get']);
  return (function($base, $super) {
    function $Script(){};
    var self = $Script = $klass($base, $super, 'Script', $Script);

    var def = $Script._proto, $scope = $Script._scope, $a, TMP_1, TMP_3, TMP_5, TMP_8;
    def['var'] = nil;
    self.$include((($a = $scope.Enumerable) == null ? $opal.cm('Enumerable') : $a));

    def.$initialize = TMP_1 = function(procs) {
      var $a, $b, $c, TMP_2, self = this, $iter = TMP_1._p, $yield = $iter || nil;
      if (procs == null) {
        procs = []
      }
      TMP_1._p = null;
      self['var'] = [];
      if (($yield !== nil)) {
        ($a = ($b = self).$instance_eval, $a._p = self.$block().$to_proc(), $a).call($b)};
      if (($a = procs['$any?']()) !== false && $a !== nil) {
        return ($a = ($c = procs).$each, $a._p = (TMP_2 = function(p){var self = TMP_2._s || this;if (p == null) p = nil;
        return self['$<<'](p)}, TMP_2._s = self, TMP_2), $a).call($c)
        } else {
        return nil
      };
    };
    ...
    def.$each = TMP_3 = function() {
      var $a, $b, self = this, $iter = TMP_3._p, block = $iter || nil;
      TMP_3._p = null;
      return ($a = ($b = self['var']).$each, $a._p = block.$to_proc(), $a).call($b);
    };

    def.$append = function(block) {
      var $a, $b, self = this;
      return ($a = ($b = self).$instance_eval, $a._p = block.$to_proc(), $a).call($b);
    };

    self.$alias_method("<<", "append");

    def['$has?'] = function(type) {
      var $a, $b, TMP_4, self = this;
      return ($a = ($b = self['var'])['$any?'], $a._p = (TMP_4 = function(h){var self = TMP_4._s || this;if (h == null) h = nil;
      return h.$keys().$first().$to_sym()['$=='](type.$to_sym())}, TMP_4._s = self, TMP_4), $a).call($b);
    };

    self.$alias_method("include?", "has?");

    def['$how_many?'] = TMP_5 = function(type) {
      var $a, $b, $c, TMP_6, self = this, $iter = TMP_5._p, $yield = $iter || nil;
      if (type == null) {
        type = nil
      }
      TMP_5._p = null;
      if (($yield !== nil)) {
        return ($a = ($b = self['var']).$count, $a._p = self.$block().$to_proc(), $a).call($b)
      } else if (type['$=='](nil)) {
        return self['var'].$count()
        } else {
        return ($a = ($c = self['var']).$count, $a._p = (TMP_6 = function(h){var self = TMP_6._s || this;if (h == null) h = nil;
        return h.$keys().$first().$to_sym()['$=='](type.$to_sym())}, TMP_6._s = self, TMP_6), $a).call($c)
      };
    };

    self.$alias_method("count", "how_many?");

    def.$get = function(type) {
      var $a, $b, TMP_7, self = this;
      return ($a = ($b = self['var']).$select, $a._p = (TMP_7 = function(h){var self = TMP_7._s || this;if (h == null) h = nil;
      return h.$keys().$first().$to_sym()['$=='](type.$to_sym())}, TMP_7._s = self, TMP_7), $a).call($b);
    };
    ...
    def.$to_s = function() {
      var self = this;
      return self['var'].$inspect();
    };

    return (def.$method_missing = TMP_8 = function(m, args) {
      var $a, self = this, $iter = TMP_8._p, block = $iter || nil;
      args = $slice.call(arguments, 1);
      TMP_8._p = null;
      if (($a = args['$any?']()) !== false && $a !== nil) {
        if (args.$length()['$=='](1)) {
          args = args.$first()};
        self['var']['$<<']($hash(m.$to_sym(), args));
        return self.$instance_variable_set("@" + (m), args);
        } else {
        return self.$instance_variable_get("@" + (m))
      };
    }, nil);
  })(self, null)
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/dsl.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, $c, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2;
  if (self.scripts == null) self.scripts = nil;

  $opal.add_stubs(['$<<', '$new', '$background', '$play_sound', '$character', '$dialogue', '$input', '$choice', '$stop_sound']);
  return (((($a = self.scripts) !== false && $a !== nil) ? $a : self.scripts = []))['$<<'](($a = ($b = (($c = $scope.Proc) == null ? $opal.cm('Proc') : $c)).$new, $a._p = (TMP_1 = function(){var self = TMP_1._s || this;
  self.$background($hash2(["resource"], {"resource": "resources/backgrounds/city.jpg"}));
    self.$play_sound($hash2(["id", "resource", "loop", "volume"], {"id": "background_theme", "resource": "resources/sounds/Classmate.m4a", "loop": true, "volume": 0.3}));
    self.$character($hash2(["resource", "name", "x", "y"], {"resource": "resources/characters/rosalinda.png", "name": "Rosalinda", "x": 800, "y": 120}));
    self.$character($hash2(["resource", "name", "x", "y"], {"resource": "resources/characters/ambrogia.png", "name": "Ambrogia", "x": 10, "y": 120}));
    self.$dialogue($hash2(["name", "text"], {"name": "Ambrogia", "text": "Hi!"}));
    self.$input($hash2(["name", "text", "id", "request"], {"name": "Ambrogia", "text": "My name is Ambrogia, and yours?", "id": "name", "request": "Your name"}));
    self.$dialogue($hash2(["name", "text"], {"name": "Ambrogia", "text": "Oh, hai #name#!"}));
    self.$choice($hash2(["name", "text", "id", "options"], {"name": "Ambrogia", "text": "How do you feel?", "id": "feel", "options": [$hash2(["id", "text"], {"id": "good", "text": "Good"}), $hash2(["id", "text"], {"id": "bad", "text": "Bad"})]}));
    self.$dialogue($hash2(["name", "text"], {"name": "Ambrogia", "text": "Oh, #feel#!"}));
    return self.$stop_sound($hash2(["id"], {"id": "background_theme"}));}, TMP_1._s = self, TMP_1), $a).call($b))
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/script/script.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$attr_accessor', '$begin_path', '$move_to', '$+', '$line_to', '$-', '$quadratic_curve_to', '$close_path', '$stroke', '$fill', '$>', '$[]', '$<', '$each', '$draw_image', '$shift', '$round_rect']);
  return (function($base, $super) {
    function $Canvas(){};
    ...
    def.canvas = nil;
    self.$attr_accessor("context", "canvas_id", "canvas");

    def.$initialize = function(element, context) {
      var self = this;
      if (context == null) {
        context = "2d"
      }
      self.context = context;
      self.canvas_id = element;
      return self.canvas = element.getContext(context);
    };

    def['$fill_style='] = function(color) {
      var self = this;
      return self.canvas.fillStyle = color;
    };
    ...
    def.$move_to = function(x, y) {
      var self = this;
      return self.canvas.moveTo(x, y);
    };

    def.$line_to = function(x, y) {
      var self = this;
      return self.canvas.lineTo(x, y);
    };
    ...
    def.$quadratic_curve_to = function(cpx, cpy, x, y) {
      var self = this;
      return self.canvas.quadraticCurveTo(cpx, cpy, x, y);
    };

    def.$clear_rect = function(x, y, width, height) {
      var self = this;
      return self.canvas.clearRect(x, y, width, height);
    };

    def.$round_rect = function(x, y, width, height, radius, fill, stroke) {
      var self = this;
      if (radius == null) {
        radius = 5
      }
      ...
      self.$close_path();
      if (stroke !== false && stroke !== nil) {
        self.$stroke()};
      if (fill !== false && fill !== nil) {
        return self.$fill()
        } else {
        return nil
      };
    ...
    def['$collides?'] = function(rect, x, y) {
      var $a, $b, $c, self = this;
      return ($a = ($b = (($c = x['$>'](rect['$[]']("x"))) ? x['$<'](rect['$[]']("x")['$+'](rect['$[]']("w"))) : $c), $b !== false && $b !== nil ?y['$>'](rect['$[]']("y")) : $b), $a !== false && $a !== nil ?y['$<'](rect['$[]']("y")['$+'](rect['$[]']("h"))) : $a);
    };

    def.$draw = function(ary) {
      var $a, $b, TMP_1, self = this;
      return ($a = ($b = ary).$each, $a._p = (TMP_1 = function(a){var self = TMP_1._s || this;if (a == null) a = nil;
      return self.$draw_image(a['$[]']("id"), a['$[]']("x"), a['$[]']("y"))}, TMP_1._s = self, TMP_1), $a).call($b);
    };

    def.$draw_image = function(args) {
      var $a, self = this, image = nil, x = nil, y = nil, w = nil, h = nil;
      args = $slice.call(arguments, 0);
      image = args.$shift();
      $a = $opal.to_ary(args), x = ($a[0] == null ? nil : $a[0]), y = ($a[1] == null ? nil : $a[1]), w = ($a[2] == null ? nil : $a[2]), h = ($a[3] == null ? nil : $a[3]);
      return self.canvas.drawImage(image, x, y);
    };

    return (def.$clear = function() {
      var self = this, fill_style = nil;
      fill_style = "#000";
      return self.$round_rect(2, 725, 1276, 120);
    }, nil);
  })(self, null)
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/lib/canvas.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$attr_accessor', '$add', '$get', '$destroy']);
  return (function($base, $super) {
    function $CanvasInput(){};
    var self = $CanvasInput = $klass($base, $super, 'CanvasInput', $CanvasInput);

    var def = $CanvasInput._proto, $scope = $CanvasInput._scope;
    def.canvas_input = def.destroy = def.database = def.key = nil;
    self.$attr_accessor("canvas_input", "database", "key", "destroyed");

    def.$initialize = function(id, database, key, text, x, y) {
      var self = this;
      if (text == null) {
        text = ""
      }
      ...
      self.canvas_input = new CanvasText(id, {
        x: x,
        y: y,
        placeHolder: text,
        width: 300,
      ...
      self.canvas_input.focus();
    ;
    };

    def.$get = function() {
      var self = this;
      return self.canvas_input.value;
    };

    def['$fill?'] = function() {
      var self = this;
      return self.canvas_input.value.length > 0;
    };
    ...
    def.$destroy = function() {
      ...
      self.canvas_input.unfocus();
      self.canvas_input.refresh = null;
      self.canvas_input.destroy();
      delete self.canvas_input;
    ;
    };

    def['$alive?'] = function() {
      var $a, self = this;
      return ($a = self.destroy, ($a === nil || $a === false));
    };
    ...
    return (def['$save_and_destroy!'] = function() {
      var self = this;
      self.database.$add(self.key, self.$get());
      self.$destroy();
      return nil;
    }, nil);
  })(self, null)
...
//@ sourceMappingURL=/__opal_source_maps__/lib/canvas/canvasinput.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$attr_accessor', '$config', '$[]', '$draw_text']);
  return (function($base, $super) {
    function $CanvasText(){};
    var self = $CanvasText = $klass($base, $super, 'CanvasText', $CanvasText);

    var def = $CanvasText._proto, $scope = $CanvasText._scope, TMP_1;
    def.canvas_text = nil;
    self.$attr_accessor("canvas_text");

    def.$initialize = TMP_1 = function(element, hash) {
      var self = this, $iter = TMP_1._p, $yield = $iter || nil;
      if (hash == null) {
        hash = nil
      }
      TMP_1._p = null;
      $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [element, "2d"]);
      self.canvas_id = element;
      
      self.canvas_text = new CanvasText;
    ;
    ...
    def.$config = function(hash) {
      var self = this;
      
      self.canvas_text.config({
    ...
    def.$draw_text = function(hash) {
      var $a, self = this;
      
      self.canvas_text.drawText({
        x        : hash['$[]']("x"),
        y        : hash['$[]']("y"),
        text     : hash['$[]']("text"),
        boxWidth : ((($a = hash['$[]']("box_width")) !== false && $a !== nil) ? $a : "130px")
      });
    ;
    };

    return (def.$write = function(what, keep) {
      var self = this;
      if (keep == null) {
        keep = false
      }
      return self.$draw_text($hash2(["x", "y", "text", "box_width"], {"x": 5, "y": 760, "text": what, "box_width": "130px"}));
    }, nil);
  })(self, (($a = $scope.Canvas) == null ? $opal.cm('Canvas') : $a))
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/lib/canvas/canvastext.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$attr_accessor', '$new', '$block!', '$each_with_index', '$round_rect', '$[]', '$draw_text', '$add_listener', '$lambda', '$-', '$collides?', '$add', '$each', '$clear_rect', '$+', '$free!', '$call']);
  return (function($base, $super) {
    function $CanvasButton(){};
    var self = $CanvasButton = $klass($base, $super, 'CanvasButton', $CanvasButton);

    var def = $CanvasButton._proto, $scope = $CanvasButton._scope, TMP_1;
    def.block = nil;
    self.$attr_accessor("block");

    def.$initialize = TMP_1 = function(element, hash, block) {
      ...
      TMP_1._p = null;
      $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [element, hash]);
      return self.block = ((($a = block) !== false && $a !== nil) ? $a : (($b = ((($c = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $c))._scope).Block == null ? $b.cm('Block') : $b.Block).$new());
    };

    return (def.$get_choice = function(database, options, key, on_success) {
      var $a, $b, TMP_2, self = this, fill_style = nil, rect = nil;
      self.block['$block!']();
      fill_style = "rgba(200, 54, 54, 0.5)";
      rect = [$hash2(["x", "y", "w", "h", "tx", "ty"], {"x": 250, "y": 790, "w": 300, "h": 50, "tx": 260, "ty": 825}), $hash2(["x", "y", "w", "h", "tx", "ty"], {"x": 750, "y": 790, "w": 300, "h": 50, "tx": 760, "ty": 825})];
      return ($a = ($b = rect).$each_with_index, $a._p = (TMP_2 = function(r, i){var self = TMP_2._s || this, $a, $b, TMP_3;
        if (self.canvas_id == null) self.canvas_id = nil;
if (r == null) r = nil;if (i == null) i = nil;
      self.$round_rect(r['$[]']("x"), r['$[]']("y"), r['$[]']("w"), r['$[]']("h"));
        self.$draw_text($hash2(["x", "y", "text", "box_width"], {"x": r['$[]']("tx"), "y": r['$[]']("ty"), "text": options['$[]'](i)['$[]']("text"), "box_width": "" + (r['$[]']("w")) + "px"}));
        return (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$add_listener("click", self.canvas_id, ($a = ($b = self).$lambda, $a._p = (TMP_3 = function(e){var self = TMP_3._s || this, $a, $b, TMP_4, x = nil, y = nil;
          if (self.canvas_id == null) self.canvas_id = nil;
          if (self.block == null) self.block = nil;
if (e == null) e = nil;
        x = (e.pageX)['$-'](self.canvas_id.offsetLeft);
          y = (e.pageY)['$-'](self.canvas_id.offsetTop);
          if (($a = self['$collides?'](r, x, y)) !== false && $a !== nil) {
            database.$add(key, options['$[]'](i)['$[]']("id"));
            ($a = ($b = rect).$each, $a._p = (TMP_4 = function(tr){var self = TMP_4._s || this;if (tr == null) tr = nil;
            return self.$clear_rect(tr['$[]']("x")['$-'](10), tr['$[]']("y")['$-'](10), tr['$[]']("w")['$+'](20), tr['$[]']("h")['$+'](15))}, TMP_4._s = self, TMP_4), $a).call($b);
            self.block['$free!']();
  ...
  })(self, (($a = $scope.CanvasText) == null ? $opal.cm('CanvasText') : $a))
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/lib/canvas/canvasbutton.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$attr_accessor', '$alias_method', '$get']);
  return (function($base, $super) {
    function $Image(){};
    var self = $Image = $klass($base, $super, 'Image', $Image);

    var def = $Image._proto, $scope = $Image._scope, TMP_1, TMP_2;
    def.id = def.klass = def.src = nil;
    self.$attr_accessor("src", "id", "klass");

    def.$initialize = TMP_1 = function(element, src, id, klass) {
      var self = this, $iter = TMP_1._p, $yield = $iter || nil;
      if (id == null) {
        id = ""
      }
      ...
      TMP_1._p = null;
      $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [element]);
      self.src = src;
      self.id = id;
      return self.klass = klass;
    };

    def.$append_to_html = function() {
      var self = this;
      
      var img = document.createElement('img');
          img.id        = self.id;
          img.className = self.klass;
          img.src       = self.src;
      document.body.appendChild(img);
    
    };

    self.$alias_method("write", "append_to_html");

    self.$alias_method("save", "append_to_html");

    return (def.$draw = TMP_2 = function(x, y) {
      var $a, self = this, $iter = TMP_2._p, $yield = $iter || nil;
      TMP_2._p = null;
      return $opal.find_super_dispatcher(self, 'draw', TMP_2, null).apply(self, [[$hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get(self.id), "x": x, "y": y})]]);
    }, nil);
  })(self, (($a = $scope.Canvas) == null ? $opal.cm('Canvas') : $a))
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/lib/image.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$attr_accessor', '$flatten', '$lambda']);
  return (function($base, $super) {
    function $Sound(){};
    var self = $Sound = $klass($base, $super, 'Sound', $Sound);

    var def = $Sound._proto, $scope = $Sound._scope;
    def.sound = nil;
    self.$attr_accessor("sound");

    def.$initialize = function(sounds, loop, volume, on_end) {
      var self = this, $a, $b, TMP_1;
      if (loop == null) {
        loop = false
      }
      if (volume == null) {
      ...
      if (on_end == null) {
        on_end = ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(){var self = TMP_1._s || this;
    ...
    def.$mute = function() {
      var self = this;
      return self.sound.mute();
    };

    return (def.$unmute = function() {
      var self = this;
      return self.sound.unmute();
    }, nil);
  })(self, null)
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/lib/sound.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$attr_accessor', '$[]=', '$to_sym', '$stop', '$delete', '$play', '$[]', '$pause', '$mute', '$unmute']);
  return (function($base, $super) {
    function $SoundManager(){};
    var self = $SoundManager = $klass($base, $super, 'SoundManager', $SoundManager);

    var def = $SoundManager._proto, $scope = $SoundManager._scope;
    def.sounds = nil;
    self.$attr_accessor("sounds");

    def.$initialize = function() {
      var self = this;
      return self.sounds = $hash2([], {});
    };

    def.$add = function(id, sound) {
      var self = this;
      return self.sounds['$[]='](id.$to_sym(), sound);
    };

    def.$remove = function(id) {
      var self = this;
      self.$stop(id);
      return self.sounds.$delete(id);
    };

    def.$play = function(id) {
      var self = this;
      return self.sounds['$[]'](id.$to_sym()).$play();
    };

    def.$pause = function(id) {
      var self = this;
      return self.sounds['$[]'](id.$to_sym()).$pause();
    };

    def.$stop = function(id) {
      var self = this;
      return self.sounds['$[]'](id.$to_sym()).$stop();
    };

    def.$mute = function(id) {
      var self = this;
      return self.sounds['$[]'](id.$to_sym()).$mute();
    };

    return (def.$unmute = function(id) {
      var self = this;
      return self.sounds['$[]'](id.$to_sym()).$unmute();
    }, nil);
  })(self, null)
})(Opal);

//@ sourceMappingURL=/__opal_source_maps__/soundmanager.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2, canvas_id = nil, go_next = nil, canvas = nil, script = nil, database = nil, block = nil, config = nil, canvas_text = nil, canvas_button = nil, sound_manager = nil, images = nil, input = nil, next_dialogue = nil;
  if (self.scripts == null) self.scripts = nil;

  $opal.add_stubs(['$get', '$new', '$reverse', '$get_all', '$lambda', '$free?', '$destroyed?', '$alive?', '$fill?', '$any?', '$is_a?', '$save_and_destroy!', '$fill_style=', '$pop', '$first', '$keys', '$===', '$add', '$[]', '$play', '$call', '$stop', '$filename', '$save', '$draw', '$<<', '$clear', '$include?', '$write', '$apply', '$get_choice', '$add_listener']);
  ;
  ;
  ;
  ;
  ...
  ;
  ;
  canvas_id = (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("game");
  go_next = (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("next");
  canvas = (($a = $scope.Canvas) == null ? $opal.cm('Canvas') : $a).$new(canvas_id);
  script = (($a = $scope.Script) == null ? $opal.cm('Script') : $a).$new(self.scripts).$get_all().$reverse();
  database = (($a = ((($b = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $b))._scope).Database == null ? $a.cm('Database') : $a.Database).$new();
  block = (($a = ((($b = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $b))._scope).Block == null ? $a.cm('Block') : $a.Block).$new();
  config = $hash2(["canvas_id", "font_family", "font_size", "font_color"], {"canvas_id": "game", "font_family": "Arial", "font_size": "30px", "font_color": "#000"});
  canvas_text = (($a = $scope.CanvasText) == null ? $opal.cm('CanvasText') : $a).$new(canvas_id, config);
  canvas_button = (($a = $scope.CanvasButton) == null ? $opal.cm('CanvasButton') : $a).$new(canvas_id, config, block);
  sound_manager = (($a = $scope.SoundManager) == null ? $opal.cm('SoundManager') : $a).$new();
  images = [];
  input = nil;
  next_dialogue = ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, $c, $d, $e, $f, current = nil, $case = nil, background = nil, character = nil;
  if (($a = ($b = ($c = block['$free?'](), $c !== false && $c !== nil ?(((($d = ((($e = ($f = input, ($f === nil || $f === false))) !== false && $e !== nil) ? $e : input['$destroyed?']())) !== false && $d !== nil) ? $d : (($e = input['$alive?'](), $e !== false && $e !== nil ?input['$fill?']() : $e)))) : $c), $b !== false && $b !== nil ?script['$any?']() : $b)) !== false && $a !== nil) {
      if (($a = ($b = input['$is_a?']((($c = $scope.CanvasInput) == null ? $opal.cm('CanvasInput') : $c)), $b !== false && $b !== nil ?input['$alive?']() : $b)) !== false && $a !== nil) {
        input['$save_and_destroy!']()};
      canvas['$fill_style=']("#fff");
      current = script.$pop();
      return (function() {$case = current.$keys().$first();if ("play_sound"['$===']($case)) {sound_manager.$add(current['$[]']("play_sound")['$[]']("id"), (($a = $scope.Sound) == null ? $opal.cm('Sound') : $a).$new(current['$[]']("play_sound")['$[]']("resource"), current['$[]']("play_sound")['$[]']("loop"), current['$[]']("play_sound")['$[]']("volume")));
      sound_manager.$play(current['$[]']("play_sound")['$[]']("id"));
      return next_dialogue.$call();}else if ("stop_sound"['$===']($case)) {sound_manager.$stop(current['$[]']("stop_sound")['$[]']("id"));
      return next_dialogue.$call();}else if ("background"['$===']($case)) {background = (($a = $scope.Image) == null ? $opal.cm('Image') : $a).$new(canvas_id, current['$[]']("background")['$[]']("resource"), current['$[]']("background")['$[]']("resource").$filename(), "asset");
      background.$save();
      background.$draw(0, 0);
      images['$<<'](background);
      return next_dialogue.$call();}else if ("character"['$===']($case)) {character = (($a = $scope.Image) == null ? $opal.cm('Image') : $a).$new(canvas_id, current['$[]']("character")['$[]']("resource"), current['$[]']("character")['$[]']("resource").$filename(), "asset");
      character.$save();
      character.$draw(current['$[]']("character")['$[]']("x"), current['$[]']("character")['$[]']("y"));
      images['$<<'](character);
      return next_dialogue.$call();}else if ("dialogue"['$===']($case)) {canvas.$clear();
      if (($a = current['$[]']("dialogue")['$include?']("name")) !== false && $a !== nil) {
        return canvas_text.$write("" + (current['$[]']("dialogue")['$[]']("name").$apply(database)) + ": " + (current['$[]']("dialogue")['$[]']("text").$apply(database)))
        } else {
        return canvas_text.$write(current['$[]']("dialogue")['$[]']("text").$apply(database))
      };}else if ("input"['$===']($case)) {canvas.$clear();
      if (($a = current['$[]']("input")['$include?']("name")) !== false && $a !== nil) {
      ...
      return input = (($a = $scope.CanvasInput) == null ? $opal.cm('CanvasInput') : $a).$new(canvas_id, database, current['$[]']("input")['$[]']("id"), current['$[]']("input")['$[]']("request").$apply(database));}else if ("choice"['$===']($case)) {canvas.$clear();
      if (($a = current['$[]']("choice")['$include?']("name")) !== false && $a !== nil) {
      ...
      return canvas_button.$get_choice(database, current['$[]']("choice")['$[]']("options"), current['$[]']("choice")['$[]']("id"), next_dialogue);}else { return nil }})();
      } else {
      return nil
    }}, TMP_1._s = self, TMP_1), $a).call($b);
  next_dialogue.$call();
  return (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$add_listener("click", go_next, next_dialogue);
})(Opal);
