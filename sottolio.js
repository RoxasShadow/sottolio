...
(function($opal) {
  ...
  $opal.add_stubs(['$[]', '$join', '$tap', '$each', '$<<', '$+', '$each_with_index', '$keys', '$values']);
  (function($base, $super) {
    function $Array(){};
    var self = $Array = $klass($base, $super, 'Array', $Array);

    var def = $Array._proto, $scope = $Array._scope;
    return (def.$to_js = function() {
      var $a, $b, TMP_1, self = this;
...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$attr_accessor', '$add']);
  return (function($base, $super) {
    ...
    def.canvas_input = def.value = nil;
    self.$attr_accessor("canvas_input", "value");

    return (def.$initialize = function(id, database, key, text, x, y) {
      var self = this;
      if (x == null) {
        x = 10
      }
      ...
      self.canvas_input = new CanvasInput({
        canvas: id,
        x: x,
        y: y,
        placeHolder: text,
    ...
    ;
      ...
      self.canvas_input.onsubmit(function(a, b) {
        self.value = b.value();
        database.$add(key, self.value)
...
//@ sourceMappingURL=/__opal_source_maps__/canvasinput.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  $opal.add_stubs(['$attr_accessor', '$config', '$[]', '$draw_text', '$each_with_index', '$round_rect', '$add_listener', '$lambda', '$-', '$collides?', '$add']);
  return (function($base, $super) {
    function $CanvasText(){};
    ...
    return (def.$get_choice = function(database, options, key) {
...
if (e == null) e = nil;
        x = (e.pageX)['$-'](self.canvas_id.offsetLeft);
          ...
          if (($a = self['$collides?'](r, x, y)) !== false && $a !== nil) {
            return database.$add(key, options['$[]'](i)['$[]']("id"))
            } else {
            return nil
...
//@ sourceMappingURL=/__opal_source_maps__/canvastext.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2, canvas_id = nil, canvas = nil, go_next = nil, dialogues = nil, database = nil, canvas_text = nil, res = nil, next_dialogue = nil;
  $opal.add_stubs(['$get', '$new', '$fill_style=', '$draw', '$<<', '$lambda', '$get_choice', '$reverse!', '$any?', '$clear', '$pop', '$===', '$write', '$[]', '$each', '$is_a?', '$call', '$+', '$has?', '$split', '$add_listener']);
  ;
  ;
  ;
  ;
  ...
  res = [$hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("city_background"), "x": 0, "y": 0}), $hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("girl1_character"), "x": 800, "y": 120}), $hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("girl2_character"), "x": 10, "y": 120})];
  canvas.$draw(res);
  dialogues['$<<']("Hi!");
  dialogues['$<<']($hash2(["text", "fun"], {"text": "My name is Ambrogia, and yours?", "fun": ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a;
  return (($a = $scope.CanvasInput) == null ? $opal.cm('CanvasInput') : $a).$new(canvas_id, database, "name", "Your name")}, TMP_1._s = self, TMP_1), $a).call($b)}));
  dialogues['$<<']("Oh, hai #name#!");
  dialogues['$<<']($hash2(["text", "options"], {"text": "How do you feel?", "options": ($a = ($c = self).$lambda, $a._p = (TMP_2 = function(){var self = TMP_2._s || this, choice = nil;
  choice = [$hash2(["text", "id"], {"text": "Good", "id": "good"}), $hash2(["text", "id"], {"text": "Bad", "id": "bad"})];
    return canvas_text.$get_choice(database, choice, "feel");}, TMP_2._s = self, TMP_2), $a).call($c)}));
  dialogues['$<<']("Oh, #feel#!");
  dialogues['$reverse!']();
  next_dialogue = ($a = ($d = self).$lambda, $a._p = (TMP_3 = function(){var self = TMP_3._s || this, $a, $b, TMP_4, $c, TMP_5, dialogue = nil, $case = nil, pattern = nil, r = nil;
  if (($a = dialogues['$any?']()) !== false && $a !== nil) {
      canvas.$clear();
      dialogue = dialogues.$pop();
      return (function() {$case = dialogue;if ((($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$===']($case)) {canvas_text.$write(dialogue['$[]']("text"));
      return ($a = ($b = dialogue).$each, $a._p = (TMP_4 = function(k, v){var self = TMP_4._s || this, $a, $b;if (k == null) k = nil;if (v == null) v = nil;
      if (($a = v['$is_a?']((($b = $scope.Proc) == null ? $opal.cm('Proc') : $b))) !== false && $a !== nil) {
          return v.$call()
          } else {
          return nil
        }}, TMP_4._s = self, TMP_4), $a).call($b);}else if ((($a = $scope.String) == null ? $opal.cm('String') : $a)['$===']($case)) {pattern = /\#(.+)\#/;
      r = "";
      ($a = ($c = dialogue.$split(pattern)).$each, $a._p = (TMP_5 = function(s){var self = TMP_5._s || this, $a;if (s == null) s = nil;
      return r = r['$+'](((function() {if (($a = database['$has?'](s)) !== false && $a !== nil) {
          return database.$get(s)
          } else {
          return s
        }; return nil; })()))}, TMP_5._s = self, TMP_5), $a).call($c);
      return canvas_text.$write(r);}else { return nil }})();
      } else {
      return nil
