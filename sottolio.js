...
(function($opal) {
  ...
  $opal.add_stubs(['$<<', '$new', '$background', '$playSound', '$render', '$dialogue', '$input', '$choice', '$stopSound']);
  ...
  self.$background($hash2(["resource"], {"resource": "city"}));
    self.$playSound($hash2(["resource", "loop"], {"resource": "fur_ambrogia", "loop": true}));
    ...
    return self.$stopSound($hash2(["resource"], {"resource": "fur_umbrogia"}));}, TMP_1._s = self, TMP_1), $a).call($b))
})(Opal);
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$config', '$[]', '$draw_text', '$each_with_index', '$round_rect', '$add_listener', '$lambda', '$-', '$collides?', '$add', '$call']);
  return (function($base, $super) {
    function $CanvasText(){};
    ...
    return (def.$get_choice = function(database, options, key, on_success) {
      ...
      rect = [$hash2(["x", "y", "w", "h", "tx", "ty"], {"x": 100, "y": 619, "w": 300, "h": 100, "tx": 110, "ty": 650}), $hash2(["x", "y", "w", "h", "tx", "ty"], {"x": 800, "y": 619, "w": 300, "h": 100, "tx": 810, "ty": 650})];
...
if (r == null) r = nil;if (i == null) i = nil;
      self.$round_rect(r['$[]']("x"), r['$[]']("y"), r['$[]']("w"), r['$[]']("h"));
        ...
        return (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$add_listener("click", self.canvas_id, ($a = ($b = self).$lambda, $a._p = (TMP_3 = function(e){var self = TMP_3._s || this, $a, x = nil, y = nil;
          if (self.canvas_id == null) self.canvas_id = nil;
if (e == null) e = nil;
...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2, canvas_id = nil, canvas = nil, go_next = nil, script = nil, database = nil, canvas_text = nil, characters = nil, input = nil, next_dialogue = nil;
  if (self.scripts == null) self.scripts = nil;

  $opal.add_stubs(['$get', '$new', '$fill_style=', '$reverse', '$get_all', '$lambda', '$destroyed?', '$alive?', '$fill?', '$any?', '$is_a?', '$save_and_destroy!', '$pop', '$first', '$keys', '$===', '$call', '$draw', '$[]', '$<<', '$clear', '$write', '$apply', '$get_choice', '$add_listener']);
  ;
  ;
  ;
  ;
  ...
  canvas_text = (($a = $scope.CanvasText) == null ? $opal.cm('CanvasText') : $a).$new(canvas_id, "2d", $hash2(["canvas_id", "font_family", "font_size", "font_color"], {"canvas_id": "game", "font_family": "Arial", "font_size": "30px", "font_color": "#000"}));
  characters = [];
  input = nil;
  next_dialogue = ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, $c, $d, $e, dialogue = nil, $case = nil;
  if (($a = ($b = (((($c = ((($d = ($e = input, ($e === nil || $e === false))) !== false && $d !== nil) ? $d : input['$destroyed?']())) !== false && $c !== nil) ? $c : (($d = input['$alive?'](), $d !== false && $d !== nil ?input['$fill?']() : $d)))), $b !== false && $b !== nil ?script['$any?']() : $b)) !== false && $a !== nil) {
      ...
      canvas['$fill_style=']("#fff");
      dialogue = script.$pop();
      return (function() {$case = dialogue.$keys().$first();if ("playSound"['$===']($case)) {return next_dialogue.$call()}else if ("stopSound"['$===']($case)) {return next_dialogue.$call()}else if ("background"['$===']($case)) {canvas.$draw([$hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("" + (dialogue['$[]']("background")['$[]']("resource")) + "_background"), "x": 0, "y": 0})]);
      ...
      return canvas_text.$get_choice(database, dialogue['$[]']("choice")['$[]']("options"), dialogue['$[]']("choice")['$[]']("id"), next_dialogue);}else { return nil }})();
      } else {
      return nil
