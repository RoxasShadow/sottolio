...
(function($opal) {
  ...
  $opal.add_stubs(['$[]', '$join', '$tap', '$each', '$<<', '$inspect', '$+', '$each_with_index', '$keys', '$values', '$has?', '$get', '$split']);
  (function($base, $super) {
    function $Array(){};
    var self = $Array = $klass($base, $super, 'Array', $Array);
  ...
  return (function($base, $super) {
    ...
    var def = $String._proto, $scope = $String._scope;
    return (def.$apply = function(database, pattern) {
...
(function($opal) {
  ...
  $opal.add_stubs(['$<<', '$new', '$background', '$playSound', '$render', '$dialogue', '$input', '$choice']);
  ...
  self.$background($hash2(["resource"], {"resource": "city"}));
    self.$playSound($hash2(["id", "resource", "loop", "volume"], {"id": "background_theme", "resource": "sounds/Classmate.m4a", "loop": true, "volume": 0.0}));
    self.$render($hash2(["resource", "name", "x", "y"], {"resource": "girl1", "name": "Ambrogia", "x": 800, "y": 120}));
    self.$render($hash2(["resource", "name", "x", "y"], {"resource": "girl2", "name": "Rosalinda", "x": 10, "y": 120}));
    ...
    return self.$dialogue($hash2(["name", "text"], {"name": "Ambrogia", "text": "Oh, #feel#!"}));}, TMP_1._s = self, TMP_1), $a).call($b))
})(Opal);
...
//@ sourceMappingURL=/__opal_source_maps__/canvas.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
//@ sourceMappingURL=/__opal_source_maps__/lib/canvasinput.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def.$initialize = TMP_1 = function(element, context, hash) {
      var self = this, $iter = TMP_1._p, $yield = $iter || nil;
      if (context == null) {
        context = "2d"
      }
      ...
      TMP_1._p = null;
      $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [element, context]);
      self.canvas_id = element;
...
//@ sourceMappingURL=/__opal_source_maps__/lib/canvastext.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  ...
  return (function($base, $super) {
    ...
    def.$initialize = TMP_1 = function(element, context, hash, block) {
      ...
      TMP_1._p = null;
      $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [element, context, hash]);
...
//@ sourceMappingURL=/__opal_source_maps__/lib/canvasbutton.js.map
;
/* Generated by Opal 0.5.5 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2, canvas_id = nil, go_next = nil, canvas = nil, script = nil, database = nil, block = nil, config = nil, canvas_text = nil, canvas_button = nil, sound_manager = nil, characters = nil, sounds = nil, input = nil, next_dialogue = nil;
  if (self.scripts == null) self.scripts = nil;

  $opal.add_stubs(['$get', '$new', '$reverse', '$get_all', '$lambda', '$free?', '$destroyed?', '$alive?', '$fill?', '$any?', '$is_a?', '$save_and_destroy!', '$fill_style=', '$pop', '$first', '$keys', '$===', '$add', '$[]', '$play', '$call', '$stop', '$draw', '$<<', '$clear', '$write', '$apply', '$get_choice', '$add_listener']);
  ;
  ;
  ;
  ;
  ...
  canvas_text = (($a = $scope.CanvasText) == null ? $opal.cm('CanvasText') : $a).$new(canvas_id, "2d", config);
  canvas_button = (($a = $scope.CanvasButton) == null ? $opal.cm('CanvasButton') : $a).$new(canvas_id, "2d", config, block);
  sound_manager = (($a = $scope.SoundManager) == null ? $opal.cm('SoundManager') : $a).$new();
  characters = [];
  sounds = $hash2([], {});
  input = nil;
  next_dialogue = ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, $c, $d, $e, $f, dialogue = nil, $case = nil;
  if (($a = ($b = ($c = block['$free?'](), $c !== false && $c !== nil ?(((($d = ((($e = ($f = input, ($f === nil || $f === false))) !== false && $e !== nil) ? $e : input['$destroyed?']())) !== false && $d !== nil) ? $d : (($e = input['$alive?'](), $e !== false && $e !== nil ?input['$fill?']() : $e)))) : $c), $b !== false && $b !== nil ?script['$any?']() : $b)) !== false && $a !== nil) {
      ...
      dialogue = script.$pop();
      return (function() {$case = dialogue.$keys().$first();if ("playSound"['$===']($case)) {sound_manager.$add(dialogue['$[]']("playSound")['$[]']("id"), (($a = $scope.Sound) == null ? $opal.cm('Sound') : $a).$new(dialogue['$[]']("playSound")['$[]']("resource"), dialogue['$[]']("playSound")['$[]']("loop"), dialogue['$[]']("playSound")['$[]']("volume")));
      sound_manager.$play(dialogue['$[]']("playSound")['$[]']("id"));
      return next_dialogue.$call();}else if ("stopSound"['$===']($case)) {sound_manager.$stop(dialogue['$[]']("stopSound")['$[]']("id"));
      return next_dialogue.$call();}else if ("background"['$===']($case)) {canvas.$draw([$hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("" + (dialogue['$[]']("background")['$[]']("resource")) + "_background"), "x": 0, "y": 0})]);
      return next_dialogue.$call();}else if ("render"['$===']($case)) {characters['$<<'](dialogue['$[]']("render"));
      canvas.$draw([$hash2(["id", "x", "y"], {"id": (($a = $scope.Sottolio) == null ? $opal.cm('Sottolio') : $a).$get("" + (dialogue['$[]']("render")['$[]']("resource")) + "_character"), "x": dialogue['$[]']("render")['$[]']("x"), "y": dialogue['$[]']("render")['$[]']("y")})]);
      return next_dialogue.$call();}else if ("dialogue"['$===']($case)) {canvas.$clear();
      return canvas_text.$write("" + (dialogue['$[]']("dialogue")['$[]']("name").$apply(database)) + ": " + (dialogue['$[]']("dialogue")['$[]']("text").$apply(database)));}else if ("input"['$===']($case)) {canvas.$clear();
      canvas_text.$write("" + (dialogue['$[]']("input")['$[]']("name").$apply(database)) + ": " + (dialogue['$[]']("input")['$[]']("text").$apply(database)));
      return input = (($a = $scope.CanvasInput) == null ? $opal.cm('CanvasInput') : $a).$new(canvas_id, database, dialogue['$[]']("input")['$[]']("id"), dialogue['$[]']("input")['$[]']("request").$apply(database));}else if ("choice"['$===']($case)) {canvas.$clear();
      canvas_text.$write("" + (dialogue['$[]']("choice")['$[]']("name").$apply(database)) + ": " + (dialogue['$[]']("choice")['$[]']("text").$apply(database)));
      return canvas_button.$get_choice(database, dialogue['$[]']("choice")['$[]']("options"), dialogue['$[]']("choice")['$[]']("id"), next_dialogue);}else { return nil }})();
      } else {
      return nil
